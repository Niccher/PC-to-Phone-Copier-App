...
public class Handle_Texts extends AppCompatActivity {
    ...
    // ViewModel
    private com.niccher.p2p_copier_app.viewmodels.TextViewModel textViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewModel = new ViewModelProvider(this).get(com.niccher.p2p_copier_app.viewmodels.TextViewModel.class);
